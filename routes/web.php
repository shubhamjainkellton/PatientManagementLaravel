...
Route::group(['middleware' => ['admin', 'loguser']], function () {
    ...
    Route::get('/depart_ward/{wardadmit}/create', 'WardController@warddepart');
    Route::put('/depart_ward', 'WardController@wardstore');
    ...
    Route::get('/appointment/search', 'AppointmentController@search');Route::get('/doctor/create', 'DoctorController@create');
    Route::post('/doctor', 'DoctorController@store');
    Route::get('/doctor', 'DoctorController@index');
    Route::get('/doctor/{user}/edit', 'DoctorController@edit');
    Route::post('/doctor/{user}', 'DoctorController@update')->name('doc_update');
